    ...
    try:
        with telemetry.tracer().start_as_current_span("graph.invoke") as span:
            ...
            try:
                ...
                _mark_span_waiting(span, "human_gate", exc.stage_id)
                ...
                _mark_span_waiting(span, "customer_ask", exc.stage_id)
                return _pause_waiting(
                    store,
                    pin,
                    journey_id=journey_id,
                ...
                _mark_span_waiting(span, "subagent", exc.stage_id, exc.subagent_ids)
