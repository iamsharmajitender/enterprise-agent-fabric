...
Docs map: [docs/README.md](../agent-fabric-docs/README.md). Box pack: [docs/04-architecture/agent-fabric-runtime.mdx](../agent-fabric-docs/04-architecture/agent-fabric-runtime.mdx). Stub auth: [05-reference/stub-auth.md](../agent-fabric-docs/05-reference/stub-auth.md).
