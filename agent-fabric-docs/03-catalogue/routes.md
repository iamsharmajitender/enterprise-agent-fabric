...
Active route rows match [`route/shopassist_case/`](../../agent-fabric-scripts/catalogue-seed/route/shopassist_case/), [`chats.json`](../../agent-fabric-scripts/catalogue-seed/chats.json), and [`run-chat.sh`](../../agent-fabric-scripts/catalogue-seed/run-chat.sh).
