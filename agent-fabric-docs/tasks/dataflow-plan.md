...
**Docs map:** [README.md](../README.md). **Behaviour / architecture source:** [agent-runtime](../04-architecture/agent-fabric-runtime.mdx), [route contract](https://jitendersharma.dev/playbooks/agents/intent-router/route-contract-reference), README [Memory](../../README.md#memory) / [Workflows](../../README.md#workflows) / [Retrieve](../../README.md#retrieve). Graph: `agent-runtime/app/graph/workflow.py`. Policy: `dataplane.memory_profiles.working`.
