...
**Task list:** [tool-failure-todo.md](./tool-failure-todo.md). **Docs map:** [README.md](../README.md).
...
```text
TF1 freeze envelope + category semantics + soft-empty rules (agent-fabric-docs/05-reference)
...
- [ ] Envelope schema + examples under `agent-fabric-docs/05-reference/`
