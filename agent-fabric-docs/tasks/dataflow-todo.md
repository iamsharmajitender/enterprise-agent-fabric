...
Plan: [dataflow-plan.md](./dataflow-plan.md) (includes **Present vs remaining** and proposed architecture). Docs map: [README.md](../README.md). Architecture: [agent-runtime](../04-architecture/agent-fabric-runtime.mdx). Route contract: [route-contract-reference](https://jitendersharma.dev/playbooks/agents/intent-router/route-contract-reference).
