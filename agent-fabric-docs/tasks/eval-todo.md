...
Plan: [eval-plan.md](./eval-plan.md). Docs map: [README.md](../README.md). Architecture: [agent-plane](../04-architecture/agent-plane.md), [Agent evals box](../04-architecture/narrative/enterprise-agent-fabric.mdx).
