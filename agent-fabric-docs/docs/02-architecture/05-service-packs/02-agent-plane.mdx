...
**Local seed:** **32** routes in the catalogue matrix. See [catalogue](/catalogue/).
...
**[Agent Runtime](/architecture/service-packs/agent-runtime)** · [Agent Capability Plane](/architecture/service-packs/agent-capability-registry) · [Agent Front Door](/architecture/service-packs/agent-front-door) · [Catalogue matrix](/catalogue/)
