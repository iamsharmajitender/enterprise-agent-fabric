---
title: "Agent Fabric Plane"
sidebar_label: Agent Plane
description: "Agent Fabric Plane: Agent Control Plane (ACP) and Agent Data Plane. Catalogue plus classify. Does not pin or start AR."
---
...
[Agent Fabric Front Door](/architecture/service-packs/agent-front-door) **calls** the **Agent Data Plane** (catalogue + classify). **ACP** is the sibling **control** box (policy, versions, decision audit). Neither box pins. Neither box starts AR.
...
Frozen route/session is on the [AFD](/architecture/service-packs/agent-front-door#frozen-route-session). Run pin is on [AR](/architecture/service-packs/agent-runtime). Capability versions are on the [Agent Fabric Capability Registry](/architecture/service-packs/agent-capability-registry) (same Agent Fabric Plane band).
...
AFD channel APIs: [Agent Fabric Front Door §6](/architecture/service-packs/agent-front-door#apis).
...
AFD and AR scale: [Agent Fabric Front Door §12](/architecture/service-packs/agent-front-door#scaling) · [Agent Fabric Runtime §12](/architecture/service-packs/agent-runtime#scaling).

---

## Read next

**[Agent Fabric Runtime](/architecture/service-packs/agent-runtime)** · [Agent Fabric Capability Registry](/architecture/service-packs/agent-capability-registry) · [Agent Fabric Front Door](/architecture/service-packs/agent-front-door) · [Catalogue matrix](/catalogue/)
