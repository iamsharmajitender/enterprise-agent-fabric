...
**[Agent Capability Plane](/architecture/service-packs/agent-capability-registry)** · [Agent Front Door](/architecture/service-packs/agent-front-door) · [Agent Plane](/architecture/service-packs/agent-plane) · [Patterns](/autonomy/) · [Autonomy](/autonomy/)
