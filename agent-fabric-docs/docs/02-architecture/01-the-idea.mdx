---
title: "The idea"
sidebar_label: The idea
description: "How to pitch the Fabric idea: one door, controls once, intelligence in domains."
---

# The idea

The Fabric is the shared front door and control plane for acting AI. At portfolio scale — hundreds of routes and agents — identity, routing, policy, approval, and proof run **once**. Domains keep the intelligence. What you get at that scale is auditability, observability, and governance without rebuilding them per capability.
...
![Enterprise Agent Fabric architecture: Front Door as the only ingress; inside the Agent Plane the Control Plane sits on top with the Data Plane and Agent Capability Plane side by side beneath it; Runtime executes; Shared holds Memory, RAG, Model and Tools; Audit and Observability underneath.](/diagrams/agent-fabric-architecture.svg)
