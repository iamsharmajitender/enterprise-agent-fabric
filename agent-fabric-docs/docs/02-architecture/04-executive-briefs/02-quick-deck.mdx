...
[Full decision paper](/architecture/executive-briefs/fabric-v1-brief) · [Technical design](/architecture/technical-design)
...
This is a **proof point for the operating model**, not the final production topology. Detail: [status](/catalogue/coverage-status) · [technical design](/architecture/technical-design).

For V1 scope, success measures, risks, and the leadership decision — see the [full decision paper](/architecture/executive-briefs/fabric-v1-brief).
