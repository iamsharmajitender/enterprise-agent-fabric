...
description: "Deterministic prefetch, retrieve tools, and long-term retrieve-only. Three mechanisms that are easy to conflate and must not be."
---
...
Do not add a retrieve `kind` — [capabilities](/concepts/authoring-a-product/capability).
