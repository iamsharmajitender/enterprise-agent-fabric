...
**Parent:** [Enterprise Agent Fabric](./narrative/enterprise-agent-fabric-architecture.mdx) · **Behaviour source:** [agent-front-door.mdx](./narrative/agent-front-door.mdx)  
