...
| Step | What happens |
| --- | --- |
| **One experience** | User or application enters through the enterprise front door |
| **Governed decision** | Intent understood, right capability selected, entitlement and policy verified |
...
| **Auditable outcome** | Evidence recorded — what was decided, executed, and approved |

Chat and automated jobs use the same contract. Capabilities can scale and fail independently without taking down enterprise AI.
