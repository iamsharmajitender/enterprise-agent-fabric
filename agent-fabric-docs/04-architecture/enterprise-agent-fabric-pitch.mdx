...
Executive quick deck: [Executive quick deck](./enterprise-agent-fabric-executive-deck.mdx) · Technical design: [Enterprise Agent Fabric](./enterprise-agent-fabric-architecture.mdx)
