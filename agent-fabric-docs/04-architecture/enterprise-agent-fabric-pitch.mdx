...
This creates a fragmented AI landscape. Users need to know which capability to use. Applications need to know which endpoint to call. Teams independently implement authentication, entitlement, routing, tool access, data access, monitoring, audit, approval, governance, and resilience.
...
**V1 — Establish the pattern.** Prove the enterprise operating model with Front Door, capability registry, routing and entitlement, durable execution, a common audit model, human-control patterns, and initial priority capabilities.
...
- Platform SLOs and governance integration
- Production onboarding model

**V2 — Scale the ecosystem.** Make onboarding AI capabilities repeatable across the enterprise through self-service capability onboarding, expanded policy controls, capability lifecycle management, standardised evaluation, cost and usage optimisation, and broader domain adoption.
