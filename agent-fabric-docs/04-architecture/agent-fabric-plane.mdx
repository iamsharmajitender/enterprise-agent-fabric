...
sidebar_label: Agent Fabric Plane
sidebar_position: 2
slug: /enterprise-agent-fabric/agent-fabric-plane
...
Parent: [Enterprise Agent Fabric](./enterprise-agent-fabric-architecture.mdx) · Siblings: [Agent Fabric Front Door](./agent-fabric-front-door.mdx) · [Agent Fabric Runtime](./agent-fabric-runtime.mdx) · [Agent Fabric Capability Registry](./agent-fabric-capability-registry.mdx) · [Agent Fabric Audit](./agent-fabric-audit.mdx)
...
[Agent Fabric Front Door](./agent-fabric-front-door.mdx) **calls** the **Agent Data Plane** (catalogue + classify). **ACP** is the sibling **control** box (policy, versions, decision audit). Neither box pins. Neither box starts AR.
...
Frozen route/session is on the [AFD](./agent-fabric-front-door.mdx#frozen-route-session). Run pin is on [AR](./agent-fabric-runtime.mdx). Capability versions are on the [Agent Fabric Capability Registry](./agent-fabric-capability-registry.mdx) (same Agent Fabric Plane band).
...
AFD channel APIs: [Agent Fabric Front Door §6](./agent-fabric-front-door.mdx#apis).
...
AFD and AR scale: [Agent Fabric Front Door §12](./agent-fabric-front-door.mdx#scaling) · [Agent Fabric Runtime §12](./agent-fabric-runtime.mdx#scaling).

---

## Read next

**[Agent Fabric Runtime](./agent-fabric-runtime.mdx)** · [Agent Fabric Capability Registry](./agent-fabric-capability-registry.mdx) · [Agent Fabric Front Door](./agent-fabric-front-door.mdx) · [Catalogue matrix](../03-catalogue/README.md)
