...
(
  'search_only_v1', '2026.08.1', 'One web search tool',
  '[{"name":"web_search","capability_id":"web_search","capability_version":"1.0.0","pdp_action":"web_search","risk_tier":"low"}]'::jsonb,
  'published'
),
(
  'research_assistant_v1', '2026.08.1', 'Open research tools (no corpus retrieve)',
  $$[
...
(
  'fraud_one_tool_v1', '2026.08.1', 'Draft memo after prefetch',
  '[{"name":"draft_memo","capability_id":"draft_memo","capability_version":"1.0.0","pdp_action":"draft_memo","risk_tier":"medium"}]'::jsonb,
  'published'
),
(
  'fraud_casefile_v1', '2026.08.1', 'Non-retrieve fraud tools after prefetch',
  $$[
...
(
  'fee_explain_v1', '2026.08.1', 'One retrieve tool for account fees',
...
(
  'contract_investigate_v1', '2026.08.1', 'Multiple tools including two retrieve tools',
  $$[
    {"name":"ocr_extract","capability_id":"ocr_extract","capability_version":"1.2.0","pdp_action":"ocr_extract","risk_tier":"low"},
...
(
  'account_notify_v1', '2026.08.1', 'One notify tool',
...
(
  'card_freeze_v1', '2026.08.1', 'Multi-tool card freeze write path',
  $$[
...
(
  'dispute_intake_v1', '2026.08.1', 'Multi-tool dispute intake',
  $$[
...
(
  'msa_risk_review_v1', '2026.08.1', 'Fixed MSA risk review tools',
  $$[
    {"name":"ocr_extract","capability_id":"ocr_extract","capability_version":"1.2.0","pdp_action":"ocr_extract","risk_tier":"low"},
    {"name":"clause_search","capability_id":"clause_search","capability_version":"1.0.0","pdp_action":"clause_search","risk_tier":"low"},
    {"name":"policy_search","capability_id":"policy_search","capability_version":"1.0.0","pdp_action":"policy_search","risk_tier":"low"},
...
(
  'kyc_onboarding_v2', '2026.08.1', 'KYC onboarding tools with gated activation',
  $$[
    {"name":"doc_intake","capability_id":"doc_intake","capability_version":"1.0.0","pdp_action":"doc_intake","risk_tier":"low"},
...
(
  'claims_adjudicate_v1', '2026.08.1', 'Forced playbook retrieve then named clause retrieve',
  $$[
    {"name":"policy_search","capability_id":"policy_search","capability_version":"1.0.0","pdp_action":"policy_search","risk_tier":"low"},
    {"name":"clause_search","capability_id":"clause_search","capability_version":"1.0.0","pdp_action":"clause_search","risk_tier":"low"},
    {"name":"risk_engine","capability_id":"risk_engine","capability_version":"1.0.0","pdp_action":"risk_engine","risk_tier":"medium"},
...
(
  'ticket_triage_v1', '2026.08.1', 'Parser and scorer tools, no corpus retrieve',
  $$[
...
(
  'product_explain_v1', '2026.08.1', 'Non-retrieve analyse tools after prefetch',
  $$[
...
(
  'narrow_review_v1', '2026.08.1', 'Many tools, one retrieve tool in Analyse',
  $$[
    {"name":"ocr_extract","capability_id":"ocr_extract","capability_version":"1.2.0","pdp_action":"ocr_extract","risk_tier":"low"},
    {"name":"clause_search","capability_id":"clause_search","capability_version":"1.0.0","pdp_action":"clause_search","risk_tier":"low"},
    {"name":"risk_engine","capability_id":"risk_engine","capability_version":"1.0.0","pdp_action":"risk_engine","risk_tier":"medium"},
...
(
  'contract_review_staged_v3', '2026.08.1', 'Guided contract review with multiple retrieve tools',
  $$[
    {"name":"ocr_extract","capability_id":"ocr_extract","capability_version":"1.2.0","pdp_action":"ocr_extract","risk_tier":"low"},
    {"name":"clause_search","capability_id":"clause_search","capability_version":"1.0.0","pdp_action":"clause_search","risk_tier":"low"},
    {"name":"policy_search","capability_id":"policy_search","capability_version":"1.0.0","pdp_action":"policy_search","risk_tier":"low"},
...
(
  'due_diligence_v1', '2026.08.1', 'Forced playbook retrieve then allowlisted retrieve',
  $$[
    {"name":"policy_search","capability_id":"policy_search","capability_version":"1.0.0","pdp_action":"policy_search","risk_tier":"low"},
    {"name":"clause_search","capability_id":"clause_search","capability_version":"1.0.0","pdp_action":"clause_search","risk_tier":"low"},
    {"name":"risk_engine","capability_id":"risk_engine","capability_version":"1.0.0","pdp_action":"risk_engine","risk_tier":"medium"},
...
(
  'pack_then_review_v1', '2026.08.1', 'Tools after playbook prefetch',
  $$[
    {"name":"ocr_extract","capability_id":"ocr_extract","capability_version":"1.2.0","pdp_action":"ocr_extract","risk_tier":"low"},
    {"name":"risk_engine","capability_id":"risk_engine","capability_version":"1.0.0","pdp_action":"risk_engine","risk_tier":"medium"},
    {"name":"draft_memo","capability_id":"draft_memo","capability_version":"1.0.0","pdp_action":"draft_memo","risk_tier":"medium"}
...
(
  'llm_pipeline_v1', '2026.08.1', 'Fixed LLM stages, no tools',
  $$[
...
(
  'policy_memo_v1', '2026.08.1', 'Prefetch then generate, no tools',
  $$[
...
(
  'account_notify_v1', '2026.08.1', 'One-tool notify',
  '[{"id":"notify","tool":"notify_customer","llm_role":"none"}]'::jsonb, 'published'
),
(
  'card_freeze_v1', '2026.08.1', 'Multi-tool freeze write path',
  $$[
...
(
  'dispute_intake_v1', '2026.08.1', 'Multi-tool dispute chain',
  $$[
...
(
  'pack_then_notify_v1', '2026.08.1', 'Prefetch then one notify tool',
  $$[
    {"id":"prefetch","llm_role":"none"},
...
(
  'pack_then_freeze_v1', '2026.08.1', 'Prefetch then freeze tools',
  $$[
    {"id":"prefetch","llm_role":"none"},
    {"id":"identity","tool":"identity_check","llm_role":"none"},
    {"id":"limits","tool":"limit_check","llm_role":"none"},
...
(
  'pack_then_review_v1', '2026.08.1', 'Prefetch playbook then tools then memo',
  $$[
    {"id":"prefetch","llm_role":"none"},
...
(
  'clause_lookup_v1', '2026.08.1', 'One named retrieve stage',
  '[{"id":"clause_search","tool":"clause_search","corpus":"clause-index","llm_role":"none"}]'::jsonb, 'published'
),
(
  'template_retrieve_v1', '2026.08.1', 'Two named retrieve stages plus score',
  $$[
...
(
  'msa_risk_review_v1', '2026.08.1', 'Fixed MSA retrieve stages',
  $$[
    {"id":"ocr","tool":"ocr_extract","llm_role":"none"},
...
(
  'kyc_onboarding_v2', '2026.08.1', 'KYC with branch, human gate, gated activate',
  $$[
...
(
  'ticket_triage_v1', '2026.08.1', 'Fixed stages, flexible non-retrieve tools in Analyse',
  $$[
...
(
  'product_explain_v1', '2026.08.1', 'Prefetch product terms, no retrieve tools',
  $$[
...
(
  'narrow_review_v1', '2026.08.1', 'Analyse allowlists one retrieve tool',
  $$[
...
(
  'contract_review_v3', '2026.08.1', 'Analyse allowlists multiple retrieve tools',
  $$[
    {"id":"extract","tool":"ocr_extract","llm_role":"none"},
...
INSERT INTO dataplane.prompt_packs (prompt_id, prompt_version, host, status, owner) VALUES
  ('chat_v1', '2026.08.1', 'Be a concise corporate assistant. No tools.', 'published', 'assistant-platform'),
  ('email_summarize_v2', '2026.08.1', 'Summarize this email for the banker. No tools. Return short bullets.', 'published', 'assistant-platform'),
  ('chat_session_v1', '2026.08.1', 'Continue the conversation. No tools. Do not invent facts.', 'published', 'assistant-platform'),
  ('policy_qa_v1', '2026.08.1', 'Answer from retrieved policy text only. Do not invent policy. Cite chunk ids.', 'published', 'assistant-platform'),
  ('policy_chat_v1', '2026.08.1', 'Answer from prefetched policy chunks. Use session memory. No tools.', 'published', 'assistant-platform'),
  ('search_only_v1', '2026.08.1', 'Research with web_search only. Stop when the budget is exhausted.', 'published', 'assistant-platform'),
  ('research_assistant_v1', '2026.08.1', 'Research using only allowed tools. Prefer primary sources. Stop when the brief is evidence-backed or the budget is exhausted.', 'published', 'assistant-platform'),
  ('fraud_one_tool_v1', '2026.08.1', 'The case file is already in context. Draft a memo with draft_memo only.', 'published', 'fraud-ops'),
  ('fraud_casefile_v1', '2026.08.1', 'The case file is already in context. Use OCR, risk, and draft tools. Do not retrieve corpora.', 'published', 'fraud-ops'),
  ('fee_explain_v1', '2026.08.1', 'You explain account fees. Use the fee lookup tool. Do not invent charges.', 'published', 'assistant-platform'),
  ('contract_investigate_v1', '2026.08.1', 'Investigate the document using only allowed tools. Prefer evidence over speculation. Stop when risk is assessed or budget is exhausted.', 'published', 'legal-agents'),
  ('llm_pipeline_v1', '2026.08.1', 'Do only the current stage. Do not choose the next stage. No tools.', 'published', 'assistant-platform'),
  ('policy_memo_v1', '2026.08.1', 'Draft the memo from prefetched policy only. Do not skip retrieve.', 'published', 'assistant-platform'),
  ('dispute_intake_v1', '2026.08.1', 'Summarize the dispute packet. Do not open extra cases. Do not skip stages.', 'published', 'ops'),
  ('pack_then_review_v1', '2026.08.1', 'The playbook is already packed. Draft the memo from stage outputs only.', 'published', 'legal-agents'),
  ('msa_risk_review_v1', '2026.08.1', 'You are counsel''s MSA risk-review worker. Do only the current stage. Do not choose the next stage. Do not invent tools.', 'published', 'legal-agents'),
  ('kyc_onboarding_v2', '2026.08.1', 'Summarize KYC evidence for a human reviewer. Do not recommend activation. Do not skip stages.', 'published', 'kyc-ops'),
  ('claims_adjudicate_v1', '2026.08.1', 'Formulate the clause query or draft the memo. Do not reorder stages.', 'published', 'claims-ops'),
  ('ticket_triage_v1', '2026.08.1', 'Stay inside the current stage. Inside Analyse pick parser/scorer tools. Do not invent stages.', 'published', 'ops'),
  ('product_explain_v1', '2026.08.1', 'Product terms are already packed. Stay inside the current stage allowlist.', 'published', 'product'),
  ('narrow_review_v1', '2026.08.1', 'Stay inside the current stage. Analyse may use clause_search and risk_engine only.', 'published', 'legal-agents'),
  ('contract_review_v3', '2026.08.1', 'You are counsel''s contract-review worker. Stay inside the current stage. Inside Analyse you may choose among the stage allowlist. Do not invent stages.', 'published', 'legal-agents'),
  ('due_diligence_v1', '2026.08.1', 'Extract always retrieves the playbook. Inside Analyse you may retrieve again. Do not invent stages.', 'published', 'legal-agents');

INSERT INTO dataplane.prompt_role_templates (prompt_id, prompt_version, llm_role, task_type, "text") VALUES
  ('llm_pipeline_v1', '2026.08.1', 'classify', 'classify', 'Extract the requested fields from the input only.'),
  ('llm_pipeline_v1', '2026.08.1', 'synthesis', 'synthesize', 'Rewrite or format using the previous stage output only.'),
  ('policy_memo_v1', '2026.08.1', 'synthesis', 'synthesize', 'Draft the memo from prefetched chunks only. Cite chunk ids.'),
  ('dispute_intake_v1', '2026.08.1', 'synthesis', 'synthesize', 'Summarize the dispute packet for a human reviewer. Do not recommend a payout.'),
  ('pack_then_review_v1', '2026.08.1', 'synthesis', 'synthesize', 'Draft the memo from packed playbook and stage outputs only.'),
  ('msa_risk_review_v1', '2026.08.1', 'query_formulation', 'plan', 'Write the search query for this stage''s corpus only. Do not pick a different index.'),
  ('msa_risk_review_v1', '2026.08.1', 'synthesis', 'synthesize', 'Draft the counsel memo from validated stage outputs only. Ground claims in retrieved clauses and playbook hits.'),
  ('claims_adjudicate_v1', '2026.08.1', 'query_formulation', 'plan', 'Write the clause-index query. Do not skip the forced playbook retrieve.'),
  ('claims_adjudicate_v1', '2026.08.1', 'synthesis', 'synthesize', 'Draft the claims memo from stage outputs only.'),
  ('narrow_review_v1', '2026.08.1', 'synthesis', 'synthesize', 'Draft the memo from Analyse outputs only.'),
  ('contract_review_v3', '2026.08.1', 'synthesis', 'synthesize', 'Draft the counsel memo from validated stage outputs only. Ground claims in retrieved clauses and playbook hits.'),
  ('due_diligence_v1', '2026.08.1', 'synthesis', 'synthesize', 'Draft the diligence memo from Extract and Analyse outputs only.');
...
(
  'agent-chat-v1', '2026.08.1', TRUE, 'active', 'general_chat',
  'One LLM call. Prompt only. Pattern 0 cannot take tools, retrieve tools, or a workflow. No memory, no retrieval.',
  'http://agent-runtime:3008/v1/runs', 'agent-chat-v1', NULL, NULL,
  'low_risk_chat', 'lightweight-chat', NULL, 'chat_v1', NULL, NULL, 1, 'clarify',
...
(
  ...
  'read_only_standard', 'fast-chat', NULL, 'email_summarize_v2', 'exec_bullets_v1', 'email_summarize_golden', 1, 'clarify',
...
(
  ...
  'low_risk_chat', 'lightweight-chat', NULL, 'chat_session_v1', NULL, NULL, 1, 'clarify',
  '[]'::jsonb, '["web"]'::jsonb, TRUE, '["hello","hi","chat"]'::jsonb, 0
),
(
  'agent-policy-qa-v1', '2026.08.1', TRUE, 'active', 'policy_qa',
  'App prefetches policy-engine and product-faq, then one grounded answer. No tools, no retrieve tool, no workflow, no memory.',
  'http://agent-runtime:3008/v1/runs', 'agent-policy-qa-v1', NULL, NULL,
  'read_only_standard', 'fast-chat', NULL, 'policy_qa_v1', 'cited_answer_v1', 'policy_qa_golden', 1, 'clarify',
...
(
  ...
  'read_only_standard', 'fast-chat', NULL, 'policy_chat_v1', 'cited_answer_v1', 'policy_qa_golden', 1, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-search-only', 'search_only_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', NULL, 'search_only_v1', NULL, NULL, 8, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-research-assistant', 'research_assistant_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', NULL, 'research_assistant_v1', 'research_brief_v1', 'research_assistant_golden', 16, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-fraud-one-tool', 'fraud_one_tool_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', NULL, 'fraud_one_tool_v1', 'risk_memo_v1', NULL, 6, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-fraud-casefile', 'fraud_casefile_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', NULL, 'fraud_casefile_v1', 'risk_memo_v1', NULL, 10, 'clarify',
  '["fraud:read"]'::jsonb, '["api"]'::jsonb, FALSE, '[]'::jsonb, 1
),
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-fee-explain', 'fee_explain_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', NULL, 'fee_explain_v1', 'fee_explain_out_v1', 'fee_explain_golden', 6, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-contract-investigate', 'contract_investigate_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', NULL, 'contract_investigate_v1', 'risk_memo_v1', 'contract_investigate_golden', 12, 'clarify',
...
(
  ...
  'read_only_standard', 'fast-chat', 'llm_pipeline_v1', 'llm_pipeline_v1', NULL, NULL, NULL, 'clarify',
...
(
  ...
  'read_only_standard', 'reasoning-standard', 'policy_memo_v1', 'policy_memo_v1', 'msa_memo_v1', NULL, NULL, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-account-notify', 'account_notify_v1', '2026.08.1',
  'high_risk_step_up', 'reasoning-standard', 'account_notify_v1', NULL, NULL, NULL, NULL, 'escalate_human',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-card-freeze', 'card_freeze_v1', '2026.08.1',
  'high_risk_step_up', 'reasoning-standard', 'card_freeze_v1', NULL, NULL, NULL, NULL, 'escalate_human',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-dispute-intake', 'dispute_intake_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'dispute_intake_v1', 'dispute_intake_v1', NULL, NULL, NULL, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-pack-then-notify', 'account_notify_v1', '2026.08.1',
  'high_risk_step_up', 'reasoning-standard', 'pack_then_notify_v1', NULL, NULL, NULL, NULL, 'escalate_human',
  '["notify:send"]'::jsonb, '["api"]'::jsonb, FALSE, '[]'::jsonb, 2
),
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-pack-then-freeze', 'card_freeze_v1', '2026.08.1',
  'high_risk_step_up', 'reasoning-standard', 'pack_then_freeze_v1', NULL, NULL, NULL, NULL, 'escalate_human',
  '["cards:freeze"]'::jsonb, '["api"]'::jsonb, FALSE, '[]'::jsonb, 2
),
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-pack-then-review', 'pack_then_review_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'pack_then_review_v1', 'pack_then_review_v1', 'msa_memo_v1', NULL, NULL, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-clause-lookup', 'clause_lookup_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'clause_lookup_v1', NULL, NULL, NULL, NULL, 'clarify',
  '["legal:read"]'::jsonb, '["api"]'::jsonb, FALSE, '[]'::jsonb, 2
),
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-template-retrieve', 'template_retrieve_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'template_retrieve_v1', NULL, NULL, NULL, NULL, 'clarify',
  '["legal:read"]'::jsonb, '["api"]'::jsonb, FALSE, '[]'::jsonb, 2
),
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-msa-risk-review', 'msa_risk_review_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'msa_risk_review_v1', 'msa_risk_review_v1', 'msa_memo_v1', 'msa_risk_review_golden', NULL, 'clarify',
  '["legal:read"]'::jsonb, '["api"]'::jsonb, FALSE, '[]'::jsonb, 2
),
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-kyc-onboarding', 'kyc_onboarding_v2', '2026.08.1',
  'high_risk_step_up', 'reasoning-standard', 'kyc_onboarding_v2', 'kyc_onboarding_v2', 'kyc_result_v1', 'kyc_onboarding_golden', NULL, 'escalate_human',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-claims-adjudicate', 'claims_adjudicate_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'claims_adjudicate_v1', 'claims_adjudicate_v1', 'msa_memo_v1', NULL, NULL, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-ticket-triage', 'ticket_triage_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'ticket_triage_v1', 'ticket_triage_v1', NULL, NULL, NULL, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-product-explain', 'product_explain_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'product_explain_v1', 'product_explain_v1', NULL, NULL, NULL, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-narrow-review', 'narrow_review_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'narrow_review_v1', 'narrow_review_v1', 'counsel_memo_v1', NULL, NULL, 'clarify',
...
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-contract-review', 'contract_review_staged_v3', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'contract_review_v3', 'contract_review_v3', 'counsel_memo_v1', 'contract_review_golden', NULL, 'clarify',
  '["legal:read"]'::jsonb, '["api"]'::jsonb, FALSE, '[]'::jsonb, 3
),
(
  ...
  'http://agent-runtime:3008/v1/runs', 'agent-due-diligence', 'due_diligence_v1', '2026.08.1',
  'read_only_standard', 'reasoning-standard', 'due_diligence_v1', 'due_diligence_v1', 'counsel_memo_v1', NULL, NULL, 'clarify',
  '["legal:read"]'::jsonb, '["api"]'::jsonb, FALSE, '[]'::jsonb, 3
);

INSERT INTO dataplane.retrieval (route_id, route_version, mode, scope) VALUES
  ('agent-policy-qa-v1', '2026.08.1', 'deterministic_prefetch', '["policy-engine","product-faq"]'::jsonb),
