...
Envelope + examples: [`agent-fabric-docs/05-reference/audit-event-envelope.json`](../../agent-fabric-docs/05-reference/audit-event-envelope.json). Plan: [`agent-fabric-docs/tasks/audit-plan.md`](../../agent-fabric-docs/tasks/audit-plan.md).
