...
**Task list:** [audit-todo.md](./audit-todo.md). **Docs map:** [docs/README.md](../README.md). **Parked summary:** [future-enhancement.md](./future-enhancement.md#3-audit--decision-record--evidence-chain).
...
```text
./docs/run/scripts/start-app.sh   # includes AADP :3010, AACP :3011, DB audit
