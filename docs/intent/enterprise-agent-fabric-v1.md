...
**Behaviour source:** [docs/enterprise-agent-fabric-architecture](../enterprise-agent-fabric-architecture/README.md)
...
Implement from Task 1 in `docs/tasks/todo.md` (`/build`). Do not start a new design.
