...
Docs map: [docs/README.md](../docs/README.md). Stub auth: [docs/05-reference/stub-auth.md](../docs/05-reference/stub-auth.md).
...
Consumes ADP / ACR JSON as returned by those services. Frozen shapes live under [docs/05-reference/](../docs/05-reference/). This folder does not publish contract fixtures.
