...
Docs map: [docs/README.md](../docs/README.md). Box pack: [docs/04-architecture/agent-capability-registry.md](../docs/04-architecture/agent-capability-registry.md). Stub auth: [docs/05-reference/stub-auth.md](../docs/05-reference/stub-auth.md).
...
- [`docs/05-reference/capability-account-fee-lookup.json`](../docs/05-reference/capability-account-fee-lookup.json)
- [`docs/05-reference/manifest-fee-explain.json`](../docs/05-reference/manifest-fee-explain.json)
...
Seed includes **`account_fee_lookup@1.0.0`** (published domain tool) and manifest **`fee_explain@2026.08.1`** that refs it. Operational reload: `./docs/run/scripts/seed-db.sh` (and Compose migrations).
